...
describe('StudySession', () => {
  ...
  describe('constructor', () => {
    ...
    it('should throw when deckId is missing', () => {
      expect(() => new StudySession(invalidSessionPropsWithoutDeckId)).toThrow(StudySessionValidationError);
    });

    it('should throw when startTime is missing', () => {
      expect(() => new StudySession(invalidSessionPropsWithoutStartTime)).toThrow(StudySessionValidationError);
    });

    it('should throw when study mode is invalid', () => {
      expect(() => new StudySession(invalidSessionPropsWithInvalidStudyType)).toThrow(InvalidStudyModeError);
    });
  });
  ...
  describe('update methods', () => {
    ...
    describe('setStartTime', () => {
      ...
      it('should throw when start time is empty', () => {
        ...
        expect(() => session.setStartTime('')).toThrow(StudySessionValidationError);
      });
    });
  });
});
