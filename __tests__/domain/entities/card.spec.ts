...
describe('Card', () => {
  ...
  describe('constructor', () => {
    ...
    it('should throw InvalidCardQuestionError when question is empty', () => {
      expect(() => new Card(invalidCardPropsWithEmptyQuestion)).toThrow(InvalidCardQuestionError);
    });

    it('should throw InvalidCardAnswerError when answer is empty', () => {
      expect(() => new Card(invalidCardPropsWithEmptyAnswer)).toThrow(InvalidCardAnswerError);
    });
  });
